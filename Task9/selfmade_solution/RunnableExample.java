...
public class RunnableExample implements Runnable {
    ...
    public static final String keyName = "pano";
    ...
    public static final String keyPairPath = "/home/michael/Schreibtisch/pano.pem";
    ...
    public static String getPublicIp (AmazonEC2 ec2, String instanceId){
        DescribeInstancesRequest describeRequest = new DescribeInstancesRequest();
        describeRequest.setInstanceIds(Collections.singleton(instanceId));
    ...
    public void run() {
        ...
        File myObj = new File(Integer.toString(this.num)+".txt");
        try {
